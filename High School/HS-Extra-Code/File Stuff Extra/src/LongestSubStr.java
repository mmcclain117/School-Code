...
public class LongestSubStr {
    ...
    public static void main(String[] args) {
        ...
        String x = "0001000101001000101000100000010010100101110100101";
        online();
    }

    private static void online() {
        /**
         * Unit tests the <tt>lcs()</tt> method. Reads in two strings from files
...
//        String s = in1.readAll().trim().replaceAll("\\s+", " ");
        String s = "This is the test string one of all the strings";
//        String t = in2.readAll().trim().replaceAll("\\s+", " ");
        String t = "This is the test String two that is testing the way of all this program";
        out.println("'" + lcs(s, t) + "'" + " " + lcs(s, t).length());
    }
     ...
     * <tt>s</tt> and <tt>t</tt>; the empty string if no such string
     */
