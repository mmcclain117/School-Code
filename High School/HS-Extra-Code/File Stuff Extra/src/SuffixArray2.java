 ...
 *****************************************************************************
 */
import OldVersions.SuffixArray;
...
//        String s = StdIn.readAll().replaceAll("\\s+", " ").trim();
        String s = "Test Number one of them all".replaceAll("\\s+", " ").trim();
        SuffixArray suffix = new SuffixArray(s);

        out.println("rank(" + args[0] + ") = " + suffix.rank(args[0]));
        out.println("  i ind lcp rnk select");
        out.println("---------------------------");
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (i == 0) {
                out.printf("%3d %3d %3s %3d %s\n", i, index, "-", rank, ith);
            } else {
                int lcp = suffix.lcp(i);
                out.printf("%3d %3d %3d %3d %s\n", i, index, lcp, rank, ith);
            }
        }
    }
}
