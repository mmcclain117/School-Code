...
//        int y = 768;
        ...
        frame.getContentPane().add(new RainbowPanel1(x, y, frame), BorderLayout.CENTER);
...
class RainbowPanel1 extends JPanel {

    private final int MAX_X;
    private final int MAX_Y;
//    private final JFrame FRAME;

    public RainbowPanel1(int x, int y, JFrame frame) {
        MAX_X = x;
        MAX_Y = y;
