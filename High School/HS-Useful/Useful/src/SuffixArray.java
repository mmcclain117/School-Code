...
/**
 * ****************************************************************************
 * Compilation: javac SuffixArray.java Execution: java SuffixArray < input.txt
 * Dependencies: StdIn.java StdOut.java
 *
 * A data type that computes the suffix array of a string.
 *
 * % java SuffixArray < abra.txt i ind lcp rnk select
 * --------------------------- 0 11 - 0 "!" 1 10 0 1 "A!" 2 7 1 2 "ABRA!" 3 0 4
 * 3 "ABRACADABRA!" 4 3 1 4 "ACADABRA!" 5 5 1 5 "ADABRA!" 6 8 0 6 "BRA!" 7 1 3 7
 * "BRACADABRA!" 8 4 0 8 "CADABRA!" 9 6 0 9 "DABRA!" 10 9 0 10 "RA!" 11 2 2 11
 * "RACADABRA!"
 *
 * See SuffixArrayX.java for an optimized version that uses 3-way radix
 ...
 * of a string (using constant time and space) and
 * <tt>Arrays.sort()</tt> to sort the array of suffixes. The <em>index</em> and
 * <em>length</em> operations takes constant time in the worst case. The
 * <em>lcp</em> operation takes time proportional to the length of the longest
 * common prefix. The <em>select</em> operation takes time proportional to the
 * length of the suffix and should be used primarily for debugging.
 * <p>
 ...
 * (does not create <tt>Suffix</tt> objects) and
 * <a href = "http://algs4.cs.princeton.edu/63suffix/SuffixArrayJava6.java.html">SuffixArrayJava6.java</a>,
 * which relies on the constant-time substring extraction method that existed in
 * Java 6.
 * <p>
 * For additional documentation, see
 * <a href="http://algs4.cs.princeton.edu/63suffix">Section 6.3</a> of
...
public class SuffixArray {
     ...
     * suffix
     * @throws java.lang.IndexOutOfBoundsException unless 0 &le; <em>i</em> &lt;
     * <Em>N</em>
     */
     ...
     * smallest suffix and the <em>i</em>-1st smallest suffix.
     * @throws java.lang.IndexOutOfBoundsException unless 1 &le; <em>i</em> &lt;
     * <em>N</em>
     */
