...
public class BitOutputStream extends OutputStream {
    ...
    /**
     * Create a stream that writes-through to the <code>OutputStream</code>
     ...
     * @throws RuntimeException if opening file fails for either FileNotFound or
     * for Security exceptoins
     */
    ...
    public void writeBits(String s) {
        writeBits(s.length(), Integer.parseInt(s, 2));
    }
}
