...
public class Rand1 extends JFrame {
...
//        }
    ...
    public Rand1(int r, int c) // takes arguments size of map
    {
        rows = r;
        cols = c;
...
//                            forestprob = map[i - 1][j] == FOREST ? forestprob + .25 : map[i - 1][j] == WATER ? waterprob + .1 : waterprob - .2;
                            r *= map[i - 1][j] == DESERT ? 1 - (con * .005) : map[i - 1][j] == FOREST ? 1 + (con * .005) : 1.1;
                        } else if (i + 1 < rows) {
//                            desprob = map[i + 1][j] == DESERT ? desprob + .2 : desprob - .2;
...
//                            forestprob = map[i + 1][j] == FOREST ? forestprob + .25 : map[i + 1][j] == WATER ? waterprob + .15 : waterprob - .2;
                            r *= map[i + 1][j] == DESERT ? 1 - (con * .005) : map[i + 1][j] == FOREST ? 1 + (con * .05) : 1.1;
                        } else if (j - 1 > 0) {
...
//                            forestprob = map[i][j - 1] == FOREST ? forestprob + .25 : map[i][j - 1] == WATER ? waterprob + .1 : waterprob - .2;
                            r *= map[i][j - 1] == DESERT ? 1 - (con * .005) : map[i][j - 1] == FOREST ? 1 + (con * .05) : 1.1;
                        } else if (j + 1 < cols) {
