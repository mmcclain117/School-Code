package OnlineGoThrough;

import static OnlineGoThrough.Main.strip;
import java.awt.*;
...
public class Main1 extends JFrame implements Runnable, MouseListener, MouseMotionListener, ActionListener, ChangeListener {
