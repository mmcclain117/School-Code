...
//            out.println(peeps.get(0));
            out.println(Arrays.toString(peeps.get(0).split("\t")));
            for (String xp : peeps) {
...
//                Person tem = q.get(line[3]);
                Person tem = q.get(line[4]);
                if (tem == null) {
                    sucRes3++;
                } else {
//                    if (tem.getNumber().equals(line[2])) {
                    out.println(tem.getName() + line[0] + line[1]);
                    if (tem.getName().equals(line[0] + line[1])) {
                        sucRes++;
                    } else {
                        sucRes2++;
                    }
