...
public class Kyles2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < cases; i++) {
            ...
            binaryTree.root = new Tree(Integer.parseInt(nodes[0] + ""));
...
//        if (root == null || root.data == 0) {
        if (root == null) {
            ...
            return 1 + rights(root.getRight()) + rights(root.getLeft());
        }
    }
}
...
class BT { // Binary Tree to handle insertion
    ...
    /*
     ...
     //                node.setRight(insert(node.left, data));
...
//        .add(data);
     ...
     * @return
     */
    private void insert(Tree n, int data) {
//        if (data < n.getData()) {
        if (data <= n.getData()) {
            if (n.getLeft() == null) {
                n.data = data;
