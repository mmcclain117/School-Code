...
c = obd.commands.has_command(obd.commands.RPM)
s = obd.commands.RPM
print("RPM Exist: " + str(c))
print("THE RPM "+ str(s))
print("Fuel Status: " + str(fuel_system_statuses))

obd.logger.setLevel(obd.logging.DEBUG)  # enables all debug information
oq = OBD2(obd.OBD())  # Sets up the reader
print(obd.OBDStatus.CAR_CONNECTED)
print("INFO: " + str(oq.info))
print("Status: " + str(oq.show_obd2_status()))
print("Current Sensors: " + str(oq.curr_sensors))
print("Scan Status: " + str(oq.scan_obd2_status))
print("Status: " + str(oq.obd2status))
print()
