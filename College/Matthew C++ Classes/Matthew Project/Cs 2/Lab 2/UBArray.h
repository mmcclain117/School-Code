...
using namespace std;
//V2 of UBArray. The first version had some minor bugs I didn't catch. All known bugs have been fixed.
...
public:
	...
	void Remove(const INDEX &i) {
		...
		try {
			...
			switch (e) {
			case ArrayEmpty:
				cout << "There Are No Elements In The Array. Error Code 0";

			case InvalidIndex:
				cout << "No Such Element Exists. Error Code 3";
			}
		}
	}
	int Size() {
