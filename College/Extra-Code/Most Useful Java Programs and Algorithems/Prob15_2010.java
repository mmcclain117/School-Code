 ...
 *
 * I used a lot of classes and ArrayLists for this solution to demonstrate 
...
class ore_excavation {
    ...
    void Print(String msg) {
        System.out.println(msg + fuel_to_excavate + " " + ore_type + " " + ore_mass + " " + ore_value);
    }
}
...
class mining_project {
    ...
    int cargo_size;
    int num_excavations;
    ArrayList<ore_excavation> oe;
    ArrayList<ore_values> ov;
    ArrayList<ore_excavation> returned_ore = new ArrayList<>();
    ...
    void Print() {
        int i;
        System.out.println("beg_fuel:" + beginning_fuel + " return_fuel:" + return_fuel + " cargo_size:" + cargo_size);
