...
//        Problem: Roll the Bones
//        Points: 9
        Scanner scan = new Scanner(new File("prob15.txt"));
        String line = scan.nextLine();
        while (!"X X X 0 0 0".equals(line)) {
...
//                double size = (double) .216; // Maybe error here on number of dice possibilities
    ...
    private static HashMap<Integer, Integer> cominations(int a[], int b[]) {
        HashMap<Integer, Integer> hm = new HashMap();
